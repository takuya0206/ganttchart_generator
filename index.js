...
function onEdit(e) {
  ...
  if (e.source.getActiveSheet().getName() == 'schedule') {
    ...
    if (items[1].indexOf(selectedItem, 2) > 0) {
      ...
      //フォーマットをリセット
      schedule.getRange(editedRow, baseLine, lastRow-editedRow+1, columnNum-baseLine).setBackground('');
...
function drawTodayLine (today) {
 ...
 Logger.log(markColumn-nextBaseLine);
